...
def get_dataloader(cfg, mode='train', spilt_model_for_images=True, 
    ...
    # print("all data")
    # print(dataset_folder, categories, cache_fields, n_views, batch_size, n_workers, return_idx)
        ...
        for field_name, field in self.fields.items():
            try:
                if self.cache_fields:
                    ...
                    # print("k is", k)
                    # print((field_name, model, category))
                    if k in self.cached_fields:
                        field_data = self.cached_fields[k]
                        # print("fielder data",k, field_data)
