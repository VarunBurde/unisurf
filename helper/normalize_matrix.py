...
import os
import utility.general as utils
...
def get_all_mask_points(masks_dir):
    ...
    for path in mask_paths:
        ...
        # print(mask_points_all, mask_ims)
...
def get_normalization(source_dir, use_linear_init=False):
    ...
    save_dir = os.path.join(source_dir,'cameras')
    np.savez('{0}/{1}_new.npz'.format(save_dir, cameras_filename), **cameras_new)
